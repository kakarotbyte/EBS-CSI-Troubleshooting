...
output "cluster_three_id" {
    value = module.eks_three.cluster_id
}

output "cluster_three_endpoint" {
    value = module.eks_three.cluster_endpoint
}
output "cluster_three_name" {
    value = module.eks_three.cluster_name
}
